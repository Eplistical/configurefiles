...
# init path & libs
export PATH=$HOME/script:$HOME/bin:/bin:/usr/bin:/usr/local/bin:/sbin:/usr/sbin:/usr/local/sbin:/usr/share/pvm3/lib:$HOME/bin:/opt/firefox52
...
export FC=gfortran
export F77=gfortran
export CPATH=$HOME/include:/usr/local/inclue:/usr/include:/include

# Eigen
export CPATH=/usr/local/include/eigen3:$CPATH

# Python
export PYTHONPATH="$HOME/code/Pcode/mylib"
